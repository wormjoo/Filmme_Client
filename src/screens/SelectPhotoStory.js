        ...
        return (
            <View style={{backgroundColor: '#fff'}}>
                <TouchableOpacity
                    style={{margin: 1}}
                    onPress={() =>
                        navigation.navigate("Detail_PhotoStory", {idx: id})
                    }
...
export default function PhotoStory({navigation}) {
    ...
    const _handleEditPress = useCallback(async () => {
        try {
            ...
            axios.post('http://13.125.249.247/filme/poseStory', body, {
                headers: {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                >
                    <Text style={{fontSize: 18, color: 'gray', marginRight: 18}}>
                        {'업로드'}
                    </Text>
                </TouchableOpacity>
            </View>
            ...
            {hasImg ? (
                <FlatList
                    ...
                    renderItem={({item}) => (
                        <Item item={item} edit={edit} count={count} setCount={setCount} storyIdx={storyIdx}
