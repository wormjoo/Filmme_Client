...
export default function MyPage({ navigation }) {
  ...
  // 닉네임 변경 발생
  const updateNicknameFuntion = async (updateNickname) => {
    ...
    <View style={styles.container}>
          ...
          >
            {editName ? (
              <Feather
                ...
                onPress={() => updateNicknameFuntion(nickname)}
              />
            ) : (
              <Feather
                name="edit-2"
      ...
      >
        ...
        >
          ...
          >
            <TouchableOpacity
              onPress={() => setTodayModalVisible(!todayModalVisible)}
            >
              <Ionic
                name="close"
                style={{
